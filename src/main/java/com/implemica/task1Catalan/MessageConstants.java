...
public class MessageConstants {
	...
	public static final String MSG_NUMBER_INPUT = "Enter a non-negative number: ";
	...
	public static final String MSG_INVALID_NUMBER_INPUT = "n = %s is not appropriate, because n cannot be negative";
